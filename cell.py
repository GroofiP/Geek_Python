...
class Cell:
    ...
    def __str__(self):
        return f"{self.cell} - Количество ячеек в новой клетке"
    ...
    def __sub__(self, other):
        if self.cell - other.cell < 0:
            return "Количество ячеек не может быть меньше 0"
        else:
            return Cell(self.cell - other.cell)
    ...
    def make_order(self,class_ins, cell_row):
        i = (class_ins.cell // cell_row) + 1
        for el in range(i):
            if class_ins.cell >= cell_row:
                print(cell_row * "*")
                class_ins.cell -= cell_row
            else:
                print(class_ins.cell * "*")
